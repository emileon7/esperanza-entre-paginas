...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-D0sjCyyX.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BY9sAZFC.js"),
    import("./start-BUUWSjuy.js"),
...
var ROUTER_BASEPATH = "esperanza-entre-paginas";
var SERVER_FN_BASE = "/esperanza-entre-paginas/_serverFn/";
